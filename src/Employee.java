...
public class Employee extends JPanel {
	...
	public Employee() {
		...
		lblEmployeeform.setForeground(Color.BLACK);
		...
		panelContent.setBackground(new Color(240, 128, 128));
		...
		lblEmployeemailid.setForeground(Color.BLACK);
		...
		lblEmployeephonno.setForeground(Color.BLACK);
		...
		lblEmployeetype.setForeground(Color.BLACK);
		...
		lblEsalary.setForeground(Color.BLACK);
		...
		lblEage.setForeground(Color.BLACK);
		...
		panelSearchShop.setBackground(new Color(240, 128, 128));
		...
		lblSearchemployeename.setForeground(Color.BLACK);
		...
		btnReport.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				try{
			    	...
			    	JasperDesign jdesigner=JRXmlLoader.load("C:\\Users\\vidyadeokar\\eclipse-workspace\\ComputerShopManagementSystem\\Reports\\employee.jrxml");
		...
		btnReport.setBounds(51, 4, 115, 40);
		panel.add(btnReport);
		setVisible(true);
	...
	public void getMySqLConnection(){
	    try{
	        ...
	        con=DriverManager.getConnection("jdbc:mysql://localhost:3306/shrikantvidya","root","vidya#@123");
	    	}catch(SQLException e){
	    		System.out.println("SQL Exception:"+e.getMessage());
	    	}
   }
